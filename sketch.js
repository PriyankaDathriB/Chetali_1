...
function setup() {
  ...
  snake.setAnimation("python");
  snake.scale = 0.3;
  
  wildplant = createSprite(180,320,20,20);
  wildplant.setAnimation("gameplayadventure_09_1");
  wildplant.scale = 0.1;
  ...
  fire1.setAnimation("gameplayadventure_03");
  fire1.scale = 0.2;
  
  fire2 = createSprite(240,210,20,25);
  fire2.setAnimation("gameplayadventure_03");
  fire2.scale = 0.2;
  
  fire3 = createSprite(200,210,20,25);
  fire3.setAnimation("gameplayadventure_03");
  fire3.scale = 0.2;
